package com.Pm.hitungpengeluaran.view.fragment.pemasukan.add;
...
import com.Pm.hitungpengeluaran.view.MainActivity;
    ...
    private void loadData() {
        ...
        if (mIsEdit) {
            ...
            if (pemasukan != null) {
                ...
                int Tugas = pemasukan.jmlUang;

                etKeterangan.setText(keterangan);
                etTanggal.setText(tanggal);
                etJmlUang.setText(String.valueOf(Tugas));
            }
        }
    }
